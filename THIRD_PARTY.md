...
- `zune-jpegxl` 0.5.2 fast-lossless prefix-code and JPEG XL header construction. Adapted portions
  are identified in `crates/jxl_wgpu_encode/src/prefix.rs` and
  ...
  `LICENSES/zune-jpegxl-MIT.txt`. It is not linked as a production dependency and never processes
  production pixels in this workspace.
