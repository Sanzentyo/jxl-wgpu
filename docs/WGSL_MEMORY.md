...
Default and caller-selected parametric modes 0–6 share this layout. The host expands bounded
matrix metadata for the 17 families; the GPU performs all image-dependent quantization.
