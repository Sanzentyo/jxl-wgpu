...
in that same scalar build and retain `JXL_MODULAR_WORD_ORACLE` for exact delta/mixed/implicit Palette checks. The implicit tests also require its entry and index-audit modes.
