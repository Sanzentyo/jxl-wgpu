...
common frontend and entropy work in `FRONT-01` and `ENT-D01/02`, including recursive-stream resume
and incremental input rather than whole-input retention. In parallel, `VDCT-E02` must emit real
