...
Status date: 2026-09-15. This document is the canonical capability and implementation backlog for
...
production pixel processing moves to the CPU. Same-encoding F32 words remain unchanged, and the
old blanket PQ/HLG rejection is replaced by the specific unresolved HDR↔ICC connection error.
...
JPEG XL goal remain **Partial**. HDR↔ICC, display peak/min-nit and relative-to-max-display policy,
