...
`IO-02` remain **Partial** for CMYK/arbitrary extras, YUV/texture input and remaining encoder work.
...
`ENC-01`, `IO-02`, `FRAME-05`, `API-05` and `QA-03/06` remain **Partial**. CMYK/arbitrary extra inputs,
