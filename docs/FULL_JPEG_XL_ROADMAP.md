...
obeys exact admission, cancellation and pool reuse. Component subsets,
arbitrary ordering and global/LF transform topology remain open. `MOD-E02` stays **Partial**.
...
animation and resident/streamed lifetime cover the policy. Component subsets,
general stacks and adaptive selection remain; `MOD-E02` and the full goal stay **Partial**.
...
Shared WGSL entry constants preserve existing decoder arithmetic. Component subsets, table-free
