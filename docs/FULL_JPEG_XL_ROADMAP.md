...
Status date: 2026-09-22. This document is the canonical capability and implementation backlog for
...
obeys exact admission, cancellation and pool reuse. Mixed/implicit entries, component subsets,
...
source fits four delta entries and beats its ordinary Gradient stream. This policy still does
not mix colors/deltas, select implicit entries or learn per-group transforms.
