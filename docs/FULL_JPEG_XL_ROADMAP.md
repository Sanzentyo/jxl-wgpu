...
| `CONT-07` | P1 | **Missing** | Implement the ISO/IEC 18181-2:2026 HDR Gain Map box (`jhgm`): bounded parsing and emission, auxiliary image GPU decoding, and requested alternate dynamic-range reconstruction with its color/metadata contract and independent interoperability evidence. Opaque box preservation alone is not gain-map support. | `CONT-01`, `COLOR-02` |
