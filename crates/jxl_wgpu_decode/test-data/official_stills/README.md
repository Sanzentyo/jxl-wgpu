...
These six inputs, ICC profiles and JSON descriptors are unchanged files from the
...
identifies these six source images as CC0 and permits test-data reproduction for testing.
...
as in the official runner. RGB output uses the reference sRGB encoding; `spot`
