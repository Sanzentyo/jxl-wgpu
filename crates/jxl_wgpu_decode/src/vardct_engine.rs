...
//! frame, independently bounded LF groups, GPU-decoded mixed strategy/quantization/correlation
//! metadata, and GPU-decoded single-pass AC coefficients for every JPEG XL VarDCT strategy. No
//! pixel, coefficient, transform, quantization, residual, or entropy fallback runs on the CPU.
