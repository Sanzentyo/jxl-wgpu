...
pub(crate) use side_image::{
    JpegQuantizationCapture, ModularSideImageJob, ModularSideImagePipeline, ModularSideImageStatus,
    ModularSideImageStreamPlan, RawHfDequantSideImagePipeline, RawHfDequantTarget,
