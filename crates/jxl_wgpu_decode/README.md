...
## Requested display luminance

`GpuOutputRequest::with_tone_mapping(jxl_gpu_protocol::LuminanceRange)` opts color presentation
into BT.2408 luminance mapping. Image intensity/minimum light and protected absolute/relative
