...
fn canonical_pitch_linear_formats_match_scalar_oracle() {
    ...
    let formats = vec![
        PixelFormat::luma(8, limited_center.clone()),
        PixelFormat::luma(16, limited_center.clone()),
        PixelFormat::i444(8, 8, full_center.clone()).unwrap(),
        PixelFormat::i422(8, 8, limited_center.clone()).unwrap(),
        PixelFormat::i420(8, 8, limited_center.clone()).unwrap(),
        PixelFormat::nv12(limited_center.clone()),
        PixelFormat::nv12(bt601_limited),
        PixelFormat::nv21(limited_center.clone()),
        PixelFormat::nv24(full_center.clone()),
        PixelFormat::nv42(full_center.clone()),
        PixelFormat::p010(limited_center.clone()),
        PixelFormat::p012(limited_center.clone()),
        PixelFormat::p016(limited_center.clone()),
        PixelFormat::i420(12, 16, limited_center.clone()).unwrap(),
        PixelFormat::packed_yuv4228(Packed422Order::Yuyv, limited_center.clone()),
        PixelFormat::packed_yuv4228(Packed422Order::Uyvy, limited_center),
        PixelFormat::rgb8(RgbChannelOrder::Rgb, false, full_center.clone()),
        PixelFormat::rgb8(RgbChannelOrder::Bgr, false, full_center.clone()),
        PixelFormat::rgb8(RgbChannelOrder::Rgba, false, full_center.clone()),
        PixelFormat::rgb8(RgbChannelOrder::Bgra, false, full_center.clone()),
        PixelFormat::rgb8(RgbChannelOrder::Rgb, true, full_center.clone()),
