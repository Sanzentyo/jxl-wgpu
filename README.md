...
| Encode | Lossless Modular Gray/RGB/RGBA with 1–31-bit integers or IEEE binary16/binary32, including supported animation; experimental GPU VarDCT with all 27 transform strategies. | Other floating precisions, arbitrary extra planes and input layouts remain; VarDCT lacks general perceptual-quality guarantees, adaptive rate control, and progressive encoding. |
