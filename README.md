...
animation and recursive DC. This provides unrounded working output for future canvas/reference
composition; JPEG XL floating-point source metadata and complete frame composition remain pending.
