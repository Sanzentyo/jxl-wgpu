...
| Encode | Lossless Modular Gray/RGB/RGBA at 1–31-bit integer depth, including supported animation; experimental GPU VarDCT with all 27 transform strategies. | VarDCT lacks general perceptual-quality guarantees, adaptive rate control, and progressive encoding. |
