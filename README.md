...
`FrameProgression::Modular` updates. Each next request resumes only to its next boundary. Broader LF
conformance, LF previews with extras, composed numeric updates and incomplete-frame input remain open.
...
and resampled extra channels. Broader LF conformance, LF previews with extras, composed numeric
updates and incomplete-frame readiness remain.
